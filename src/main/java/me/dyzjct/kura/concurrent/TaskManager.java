package me.dyzjct.kura.concurrent;

import me.dyzjct.kura.concurrent.repeat.DelayUnit;
import me.dyzjct.kura.concurrent.repeat.RepeatManager;
import me.dyzjct.kura.concurrent.repeat.RepeatUnit;
import me.dyzjct.kura.concurrent.task.*;
import me.dyzjct.kura.concurrent.thread.BackgroundMainThread;
import me.dyzjct.kura.concurrent.thread.BlockingContent;
import me.dyzjct.kura.concurrent.utils.Syncer;
...
public class TaskManager {
    ...
    public static void launch(BlockingContent content, VoidTask task) {
        content.launch(task);
    }
