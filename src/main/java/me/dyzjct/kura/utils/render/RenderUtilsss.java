...
//            float f2 = Speedmine.getInstance().timer.getPassedTimeMs() / 1000.0f / (Speedmine.getInstance().breakTime * OyVey.serverManager.getTpsFactor());
//            f2 = Math.min(f2, 1.0f);
//            double d9;
//            double d10;
//            double d11;
...
//        GlStateManager.disableDepth();
//        GlStateManager.translate(-((double) CFontRenderer.getStringWidth(text) / 2.0), 0.0, 0.0);
//        CFontRenderer.drawStringWithShadows(text, 0.0f, 0.0f, -5592406);
//        GlStateManager.popMatrix();
//    }
    ...
    public static void drawBBBox(AxisAlignedBB BB, Color colour, int alpha) {
