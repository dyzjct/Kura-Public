...
public class ColorUtil {
    ...
    public static int toARGB(int r, int g, int b, int a) {
        return (new me.dyzjct.kura.utils.color.Colors(r, g, b, a)).getRGB();
    }
    ...
    public static int toRGBA(me.dyzjct.kura.utils.color.Colors color) {
    ...
    public static class HueCycler {
        ...
        public HueCycler(int cycles) {
            ...
            for (int i = 0; i < cycles; i++) {
                this.cycles[i] = me.dyzjct.kura.utils.color.Colors.HSBtoRGB((float) hue, 1.0F, 1.0F);
                hue += add;
            }
        }
