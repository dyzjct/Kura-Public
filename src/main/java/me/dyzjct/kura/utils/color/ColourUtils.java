...
public class ColourUtils {
    public static char getChatColorFromIndex(int i) {
        switch (i) {
            case 0:
                return '0';
            case 1:
    ...
    public int colorToHex(me.dyzjct.kura.utils.color.Colors c) {
        return Integer.decode("0x"
                + Integer.toHexString(c.getRGB()).substring(2));
    }

    public String getColorNameFromColor(me.dyzjct.kura.utils.color.Colors color) {
    ...
    public static int GenRainbow() {
        ...
        int rgb = me.dyzjct.kura.utils.color.Colors.HSBtoRGB(hue[0], 1.0f, 1.0f);
        int red = rgb >> 16 & 255;
        int green = rgb >> 8 & 255;
        int blue = rgb & 255;
    ...
    public static int GayRainbow() {
        int color;
        float[] hue = new float[]{(float) (System.currentTimeMillis() % 11520L) / 11520.0f};
        int rgb = me.dyzjct.kura.utils.color.Colors.HSBtoRGB(hue[0], 1f, 1f);
        int red = rgb >> 24 & 255;
        int green = rgb >> 8 & 255;
        int blue = rgb & 255;
        color = toRGBA(red, green, blue, 43);
        return color;
    }
