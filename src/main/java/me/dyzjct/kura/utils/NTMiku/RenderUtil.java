...
//import me.dyzjct.arkhack.ArkTeam;
...
//    public static void drawTextz(AxisAlignedBB pos, String text) {
//        if (pos == null || text == null) {
//            return;
//        }
//        GlStateManager.pushMatrix();
//        RenderUtil.glBillboardDistanceScaled((float)pos.minX + 0.5f, (float)pos.minY + 0.5f, (float)pos.minZ + 0.5f, (EntityPlayer)RenderUtil.mc.player, 1.0f);
//        GlStateManager.disableDepth();
//        GlStateManager.translate((double)(-((double)ArkTeam.textManager.getStringWidth(text) / 2.0)), (double)0.0, (double)0.0);
//        ArkTeam.textManager.drawStringWithShadow(text, 0.0f, 0.0f, -5592406);
//        GlStateManager.popMatrix();
//    }

    public static void drawSexyBoxArkTeamIsRetardedFuckYouESP(AxisAlignedBB a, Color boxColor, Color outlineColor, float lineWidth, boolean outline, boolean box, float alpha, float scale, float slab) {
