...
public class CFont {
    ...
    public CFont(CustomFont font, boolean antiAlias, boolean fractionalMetrics) {
        try {
            Font inputFont;
            this.font = inputFont = Font.createFont(font.getType(), CFont.class.getResourceAsStream(font.getFile())).deriveFont(font.getSize()).deriveFont(font.getStyle());
            this.antiAlias = antiAlias;
            this.fractionalMetrics = fractionalMetrics;
    ...
    public static class CustomFont {
        ...
        public CustomFont(String file, float size, int style) {
            this(file, size, style, 0);
        }

        public CustomFont(String file, float size, int style, int type) {
            this.file = file;
            this.size = size;
            this.style = style;
            this.type = type;
