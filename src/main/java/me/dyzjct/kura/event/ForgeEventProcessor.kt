package me.dyzjct.kura.event

import com.google.common.base.Strings
import me.dyzjct.kura.Kura
import me.dyzjct.kura.command.Command
import me.dyzjct.kura.command.commands.mc.PeekCommand
import me.dyzjct.kura.event.events.client.ConnectEvent
                    ...
                    when ((event.packet as SPacketPlayerListItem).action) {
                        ...
                        SPacketPlayerListItem.Action.REMOVE_PLAYER -> {
                            ...
                            if (entity != null) {
                                ...
                                MinecraftForge.EVENT_BUS.post(DisconnectEvent(logoutName))
                            }
                            MinecraftForge.EVENT_BUS.post(DisconnectEvent(null))
                        }
                    }
                }
        }
