package me.dyzjct.kura.gui.alt.utils;
...
public class PasswordField extends Gui
{
    ...
    public void writeText(final String par1Str) {
        ...
        final int var4 = Math.min(this.cursorPosition, this.selectionEnd);
        final int var5 = Math.max(this.cursorPosition, this.selectionEnd);
    ...
    public void drawTextBox() {
        if (this.isVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtils.drawRoundedRectangle(this.xPos - 1, this.yPos - 1, this.width+2, this.height+2, (int)(this.height/2F)-3F, new Color(160, 160, 160));
                RenderUtils.drawRoundedRectangle(this.xPos, this.yPos, this.width, this.height, (int)(this.height/2F)-3F, new Color(0, 0, 0));
            }
