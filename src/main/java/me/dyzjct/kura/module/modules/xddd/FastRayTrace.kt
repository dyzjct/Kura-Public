    ...
    companion object {
        fun rayTraceVisible(
            ...
            return !fastRaytrace(
                ...
                if (blockState.getCollisionBoundingBox(Minecraft.getMinecraft().world, pos) != null) {
        ...
        fun fastRaytrace(
            ...
            val startBlockState = Minecraft.getMinecraft().world.getBlockState(mutableBlockPos)
            ...
            while (count-- >= 0) {
                ...
                mutableBlockPos.setPos(currentBlockX, currentBlockY, currentBlockZ)
                val blockState = Minecraft.getMinecraft().world.getBlockState(mutableBlockPos)
