...
import me.dyzjct.kura.utils.inventory.Pair;
 ...
 */
@Module.Info(name = "AutoReplenish", category = Category.COMBAT, description = "Refills items in your hotbar")
public class AutoReplenish extends Module {

    private final Setting<Integer> threshold = isetting("RefillAt", 32, 1, 64);
    private final Setting<Integer> tickDelay = isetting("TickDelay", 1, 1, 10);
