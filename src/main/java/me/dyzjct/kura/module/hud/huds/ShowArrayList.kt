...
import me.dyzjct.kura.module.ModuleManager.getModules
...
import me.dyzjct.kura.utils.gl.MelonTessellator.drawRect
...
class ShowArrayList : HUDModule() {
    ...
    companion object {
        var fonts = CFontRenderer(CFont.CustomFont("/assets/fonts/Montserrat.ttf", 20f, Font.PLAIN), true, false)
