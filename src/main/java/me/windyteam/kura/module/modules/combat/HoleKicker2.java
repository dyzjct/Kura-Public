...
import me.windyteam.kura.utils.fn.BlockHelper;
import me.windyteam.kura.utils.fn.CombatUtil;
import me.windyteam.kura.utils.fn.PlayerSpoofUtil;
import me.windyteam.kura.utils.fn.TimerUtil;
...
//        mc.player.connection.sendPacket(new CPacketPlayerDigging(CPacketPlayerDigging.Action.ABORT_DESTROY_BLOCK, minePos, BlockUtil.getRayTraceFacing(minePos)));
    ...
    public class PushInfo {
        ...
        public PushInfo(BlockPos pistonPos, boolean rayTrace, boolean instaMineC, EnumFacing pisFac, boolean pullMode) {
            this.pistonPos = pistonPos;
            this.rstPos = HoleKicker2.this.getRSTPos2(pistonPos, 6.0D, rayTrace, instaMineC, false);
            this.pisFac = pisFac;
            this.pullMode = pullMode;
        }
