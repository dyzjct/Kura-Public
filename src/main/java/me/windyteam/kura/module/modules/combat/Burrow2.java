...
import me.windyteam.kura.utils.block.SeijaBlockUtil;
...
//        }
        ...
        this.isSneaking = BlockUtil2.placeBlock(new BlockPos(getPlayerPosFixY(Burrow2.mc.player)), EnumHand.MAIN_HAND, this.rotate.getValue(), true, this.isSneaking);
