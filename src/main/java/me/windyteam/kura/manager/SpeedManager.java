...
public class SpeedManager {
    ...
    public static double speedometerCurrentSpeeds = 0.0;
    public static HashMap<EntityPlayer, Double> playerSpeeds = new HashMap();
    ...
    public static double getSpeedKpHs() {
        double speedometerkphdouble = turnIntoKpH(speedometerCurrentSpeeds);
        speedometerkphdouble = (double) Math.round(10.0 * speedometerkphdouble) / 10.0;
        return speedometerkphdouble;
    }
